...
(10, 1, '{"message": "Luna es linda. Viajo mucho por trabajo, estoy fuera 2-3 semanas al mes pero quiero un gato esperándome cuando regrese. Mi departamento está solo pero tengo vecina que podría darle comida.", "housing_type": "Departamento", "has_experience": false, "has_other_pets": false, "reason": "Ausencias prolongadas sin plan de cuidado adecuado"}'::jsonb, 
...
(11, 5, '{"message": "Vi que Nieve es un gato senior. Los gatos viejos no requieren mucho cuidado, verdad? Solo comen y duermen. Tengo un departamento estudio. Primera vez con gatos.", "housing_type": "Departamento estudio", "has_experience": false, "has_other_pets": false, "reason": "Desconocimiento grave de necesidades de gato senior con artritis"}'::jsonb, 
...
(8, 2, '{"message": "El siamés está bonito, me gustan los gatos elegantes. Cuánto cuesta? Lo quiero ya para este fin de semana.", "housing_type": "Departamento", "has_experience": false, "has_other_pets": false, "reason": "Actitud consumista, trata adopción como compra impulsiva"}'::jsonb, 
...
(9, 4, '{"message": "Tigre se ve muy cool para Instagram, mis seguidores amarían fotos de él. Tengo departamento chico pero no importa, no? Los gatos se adaptan.", "housing_type": "Departamento pequeño", "has_experience": false, "has_other_pets": false, "reason": "Motivación superficial (redes sociales), ignora necesidades específicas de bengalí"}'::jsonb, 
